...
set title=Back to Saturn X Episode 1: Get Out Of My Stations
...
echo %title%
echo by BTSX Team - https://www.doomworld.com/forum/topic/62529
echo.
...
-file 	"%megawadsPath%/Back to Saturn X/btsx_e1a.wad" ^
		"%megawadsPath%/Back to Saturn X/btsx_e1b.wad" ^
