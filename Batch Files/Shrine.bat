...
echo %title%
echo by scumhead - https://www.moddb.com/mods/shrine
echo.
...
-file 	"%modsPath%/Shrine/Shrine-Patched.pk3" ^
		"%enginePath%/lights.pk3" ^
-config "%configsPath%-Shrine.ini" ^
+set screenblocks 10
:: screenblocks is set to 10 to avoid a HUD problem
